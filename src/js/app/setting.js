...
//            {mona:{address:""},github:{username:"",email:"",token:"",repo:""}}
                {mona:{address:""},github:{username:username.stdout,email:email.stdout,token:"",repo:{name:await this.#defaultRepoName(),description:"著者のつぶやきサイトです。",homepage:"",topics:["website"],}}}
        )) }
